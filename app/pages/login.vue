  ...
  <div class="card bg-base-200/95 backdrop-blur-xl border border-base-300 shadow-2xl">
    <div class="card-body p-8">
      <div class="flex items-center justify-center gap-2.5 mb-8">
        ...
        <h1 class="text-xl font-bold text-base-content tracking-wide">Script Breakdown</h1>
      </div>

      <p class="text-center text-sm leading-6 text-base-content/70">Continue securely with your Replit account to access your projects.</p>
      ...
      <p class="mt-6 text-center text-xs leading-5 text-base-content/50">Replit manages account creation, sign-in, and account security.</p>
      <div class="mt-5 text-center text-sm text-base-content/70">
        New here?
        <NuxtLink to="/signup" class="link link-hover text-primary font-medium">Learn about signing up</NuxtLink>
      </div>
    </div>
  </div>
</template>
