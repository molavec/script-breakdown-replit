    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10 mt-4">
      ...
      <div class="flex items-center gap-4 w-full md:w-auto">
        <div class="relative flex-1 md:flex-none">
          ...
          <input type="text" placeholder="Search projects..." class="w-full md:w-72 bg-[#0a0a0a] border border-white/10 rounded-md pl-10 pr-4 py-2.5 text-sm focus:outline-none focus:border-white/30 focus:ring-1 focus:ring-white/30 transition-all placeholder:text-gray-600" />
        </div>
        <NuxtLink to="/projects/new" class="bg-[#e51d3b] hover:bg-[#c91932] text-white px-5 py-2.5 rounded-md text-sm font-medium flex items-center gap-2 transition-colors shrink-0">
