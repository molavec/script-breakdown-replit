...
<template>
  <header class="flex items-center justify-between px-4 sm:px-6 py-3.5 border-b border-white/5 bg-[#141414] shrink-0 sticky top-0 z-30">
    <div class="flex items-center gap-3">
      <!-- Sidebar Toggle Icon Button -->
      <button 
        type="button"
        @click="toggle"
        class="p-2 -ml-1.5 rounded-lg text-neutral-400 hover:text-white hover:bg-neutral-800/80 active:scale-95 transition-all focus:outline-none focus:ring-2 focus:ring-rose-500/40"
      ...
      >
        ...
        <svg 
          ...
          :class="isOpen ? 'text-rose-400' : 'text-neutral-400'"
        >
      ...
      <NuxtLink to="/" class="text-xl font-semibold text-rose-300 hover:text-rose-200 transition-colors">
    ...
    <div class="flex items-center gap-4">
      <!-- Settings Icon -->
      <NuxtLink to="/settings" class="text-gray-400 hover:text-white transition-colors" title="Settings">
